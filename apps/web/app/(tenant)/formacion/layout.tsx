      ...
      >
        <div style={{ fontWeight: 700, fontSize: '1rem', marginBottom: '1.5rem' }}>
          ...
          <div style={{ fontSize: '0.7rem', fontWeight: 400, opacity: 0.6, marginTop: '2px' }}>
            CampaignOS · FORMACION
          </div>
        </div>

        <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
          <NavLink href="/formacion">Materiales</NavLink>
          <NavLink href="/formacion/sesiones">Sesiones</NavLink>
          <NavLink href="/formacion/evaluaciones">Evaluaciones</NavLink>
          <NavLink href="/formacion/certificados">Mis certificados</NavLink>
          {isAdmin && <NavLink href="/formacion/reportes">Reportes</NavLink>}
        </nav>
